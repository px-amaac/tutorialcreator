...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { author: @tutorial.author, description: @tutorial.description, title: @tutorial.title, user_id: @tutorial.user_id }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { author: @tutorial.author, description: @tutorial.description, title: @tutorial.title, user_id: @tutorial.user_id }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
